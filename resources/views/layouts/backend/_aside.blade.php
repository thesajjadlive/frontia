...
<ul class="app-menu">
    ...
    <li class="treeview "><a class="app-menu__item {{ Request::is('request*')?'active':'' }}" href=" " data-toggle="treeview"><i class="app-menu__icon fa fa-hand-pointer-o"></i><span class="app-menu__label">Customer Requests</span><i class="treeview-indicator fa fa-angle-right"></i></a>
        <ul class="treeview-menu">
            <li><a class="app-menu__item {{ Request::is('request-callback')?'active':'' }}" href="{{ route('callback') }}"><i class="app-menu__icon fa fa-reply"></i><span class="app-menu__label">Callback Request</span></a></li>
            <li><a class="app-menu__item {{ Request::is('request-pending')?'active':'' }}" href="{{ route('pending') }}"><i class="app-menu__icon fa fa-spinner"></i><span class="app-menu__label">Pending Request</span></a></li>
    ...
    <li class="treeview "><a class="app-menu__item {{ Request::is('setting*')?'active':'' }}" href=" " data-toggle="treeview"><i class="app-menu__icon fa fa-cog"></i><span class="app-menu__label">Settings</span><i class="treeview-indicator fa fa-angle-right"></i></a>
        <ul class="treeview-menu">
            <li><a class="treeview-item {{ Request::is('setting/about')?'active':'' }}" href="{{ route('about.index') }}"><i class="icon fa fa-circle-o"></i>About Us</a></li>
            <li><a class="treeview-item {{ Request::is('setting/contact')?'active':'' }}" href="{{ route('contact.index') }}"><i class="icon fa fa-circle-o"></i>Contact</a></li>
            <li><a class="treeview-item {{ Request::is('setting/link')?'active':'' }}" href="{{ route('link.index') }}"><i class="icon fa fa-circle-o"></i>Logo & Links</a></li>
